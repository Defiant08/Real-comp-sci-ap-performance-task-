...
sprites.onOverlap(SpriteKind.hitbox, SpriteKind.Enemy, function (sprite, otherSprite) {
    sprites.destroy(en, effects.spray, 200)
    sprites.destroy(sprite)
})
function map_changer (num: number) {
    if (current_map == 0) {
        ...
        for (let index = 0; index < num; index++) {
            ...
            en.follow(mySprite, randint(20, 70))
        }
    } else if (current_map == 1) {
        ...
        Final_Boss = sprites.create(img`
            ...
            cff3ffffffff3ffc.................
            cfffffff11fffffc.................
            cfff22f111f22ffc........bbbbbb...
            cfff22f111122ffc.......cffffffbb.
            cffff1111111fffc......cffffffffb.
            cfff1111fff11ffc.....cfff111ffffb
            cfffc11fff11ffbc.....cff11111fffb
            cfffcc111111cfbc.....cf11dd111ffb
            cfffffbb33ccffbcc....cbddbbd11ffc
            cffffffb33cfffffbbccccbbdbbb11ffc
            cfffffffbbffffffffffffffffbb1fffc
            cffff1111fffffffffffffffffffbfffc
            cfff111111fffffffffffffffffffffc.
            cfff1111111fffffffffffffffffffcc.
            cff11111111fffffffffffffffffffc..
            cff111111111ffffffffffffffffffc..
            cbf111111111ffffffffffffffffffc..
            .1f111111111ffffffffffffffffffc..
            .11111111111ffffffffffffffffffc..
            ..1b11111111ffffffffffffffffffc..
            ...1b111111fffffff111111ffffffc..
            ...1bbb1111ffffff11111111fffffc..
            ....1bb111bffffccccccccccbffffc..
            ....1bb1..1fffc.....1bb1.cffffc..
            ....1bb1..1fffc.....1bb1.ccffffc.
            ....1bb1..1ffc.......1b1..ccfffc.
            ....1bb1..1ffc.......1bb1..ccffc.
            ....1bb1..1ffc.......1bb1...cffc.
            ....1bb1..1ffc......1bbb1...cffc.
            ...1bbb1..1ffc......1111....cbfc.
            ...1bb1..1fffc.............cfffc.
            ...1111..1ffcc.............cfffc.
            .........111c..............cccc..
            `, SpriteKind.Boss)
        FinalBossLives = 10
        tiles.placeOnRandomTile(Final_Boss, sprites.dungeon.collectibleInsignia)
        tiles.placeOnRandomTile(mySprite, assets.tile`myTile`)
        controller.moveSprite(mySprite, 100, 100)
